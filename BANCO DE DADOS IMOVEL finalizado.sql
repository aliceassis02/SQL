...
CREATE TABLE cidade(
idCidade VARCHAR (25)NOT NULL PRIMARY KEY,
nmCidade VARCHAR(25) NOT NULL,
...
CREATE TABLE bairro(
idBairro varchar (25) NOT NULL PRIMARY KEY,
nmBairro VARCHAR(25) NOT NULL,
idCidade VARCHAR (25) NOT NULL,
sgEstado varchar(25) NOT NULL,
...
idComprador varchar(25) NOT NULL PRIMARY KEY,
nmComprador VARCHAR(25) NOT NULL, 
nmEnderecoComprador VARCHAR(100) NOT NULL,
nrCPFComprador varchar(25) NOT NULL,
idCidade varchar(25)  NOT NULL,
idBairro  varchar (25) NOT NULL,
sgEstado CHAR(2) NOT NULL,
...
idVendedor varchar(25)  NOT NULL PRIMARY KEY,
...
CREATE TABLE imovel(
idImovel varchar (25) NOT NULL PRIMARY KEY,
...
CREATE TABLE oferta(
idOferta varchar (25) NOT NULL PRIMARY KEY,
idImovel varchar (25) NOT NULL,
idComprador varchar (25) NOT NULL,
...
values ('AC', 'Acre'),
    ...
    values ('rioBranco1', 'Rio Branco', 'AC'),
		...
		select *
           ...
           insert into bairro 
           values
('DI0','Distrito Industrial','Acrelandia','AC'),
...
('BR2', 'Brasil Novo', 'Rio Largo', 'AL'),
('FO', 'Forence', 'Rio largo' ,'AL'),
('AC' , 'Acai', 'Macapa' ,'AP'),
('ar0' , 'Araxa','Macapa ','AP'),
('ce2', 'centro',' Cutias', 'AP'),
('SE1','sedeCutias','cutias','AP'),
('CA', 'Cabralzinho' , 'Macapa' ,'AP'),
('BR', 'Brasil novo' , 'Macapa', 'AP'),
...
('PI', 'Pituba', 'Salvador', 'BA'),
('CA1', 'Caminho das Arvores','Salvador','BA'),
('ES','Esperanca','Ilheus','BA'),
('IG', 'Iguape', 'Ilheus', 'BA'),
('CR', 'coreia', 'juazeiro', 'BA'),
('AG', 'Agemiro','juazeiro', 'BA'),
('JD', 'Jardim', 'Fortaleza', 'CE'),
('IR', 'Iracema', 'Fortaleza', 'CE'),
('AL' ,'Alto' ,'Sobral' ,'CE'),
('BE', 'Betania', 'Sobral' ,'CE'),
('SC', 'Socorro' ,'Juazeiro do norte' ,'CE'),
('SA', 'Salgadinho' ,'Juazeiro do norte','CE'),
('AE3', 'Aeroporto', 'Vitoria' ,'ES'),
('BV', 'Boa vista', 'Vitoria', 'ES'),
('AL1' ,'Alterosas' ,'Serra', 'ES'),
('NS' ,'Nossa senhora', 'Serra' ,'ES'),
('AL2', 'Alecrim', 'Vila velha' ,'ES'),
('AR' ,'Argolas', 'Vila velha' ,'ES'),
...
('AG' ,'Agua boa' ,'Imperatriz', 'MA'),
('AN', 'Asa norte' ,'Imperatriz', 'MA'),
('AR', 'Araci' ,'Sao jose de Ribamar', 'MA'),
...
('CE5' ,'Centro', 'Tres lagoas' ,'MS'),
('PA' ,'Pampulha' ,'Belo Horizonte' ,'MG'),
('AN' ,'Anchieta' ,'Belo Horizonte' ,'MG'),
('AG' ,'Agua Branca' ,'Contagem' ,'MG'),
('BV2' ,'Bela vista', 'Contagem', 'MG'),
('NS', 'Nossa senhora do carmo', 'Betim' ,'MG'),
...
('CA' ,'Candelaria', 'Mossoro' ,'RN'),
('IN', 'Independencia', 'Mososorro', 'RN'),
